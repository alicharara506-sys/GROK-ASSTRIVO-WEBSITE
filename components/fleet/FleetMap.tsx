      ...
      >
        <span className="flex items-center gap-2">
          ...
          <span className="min-w-0">
            <span className="font-display block truncate text-[0.7rem] font-semibold tracking-[0.14em] text-white sm:text-xs">
              {agent.name}
            </span>
            <span className="mt-0.5 block line-clamp-2 text-[0.62rem] leading-snug text-muted sm:text-[0.7rem]">
              {agent.role}
            </span>
          </span>
        </span>
